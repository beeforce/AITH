...
export default class Gameproject extends Component {
    constructor() {
        super()
        this.state = {
            highScore: 0,
            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={styles.highScore}>
                        ...
                        <Text style={styles.textstyle}>{this.state.highScore}</Text>
                    </View>
 
                    <View style={styles.timeCount}>
                        <Text style={styles.textstyle}>Time</Text>
                        <Text style={styles.textstyle}>{this.state.timeCount}</Text>
                    </View>
                    <View style={styles.currentScore}>
                        <Text style={styles.textstyle}>Score</Text>
                        <Text style={styles.textstyle}>{this.state.score}</Text>
                    </View>
                </View>
...
AppRegistry.registerComponent('Gameproject', () => Gameproject);
